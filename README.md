...
Four Claude Code agents that check your work before it ships: one for code quality, one for writing, one for release-readiness on Django-on-Render projects, and one that runs a pull request's tests and certifies whether it is ready to release.
